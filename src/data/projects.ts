...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    summary: 'Flagship project developed by Mateo Gavilanes taking science beyond the laboratory using Meta Quest 3 VR headsets for schools and pediatric hospitals.',
    description: 'Our flagship innovation project develops an interactive virtual reality laboratory environment designed and developed by Mateo Gavilanes. By simulating atomic lattice interactions, cleanroom physical vapor deposition, and molecular nano-structures, this tool allows our team to visit schools and hospitals, bringing immersive scientific experiences to communities without direct access to research laboratories.',
    technologies: ['Virtual Reality', 'Meta Quest 3', 'Unity / WebXR', 'Molecular Dynamics', 'Bio-interactive Design'],
    team: ['Mateo Gavilanes (Environment Creator & Lead VR Developer)', 'Chapter Innovation Team', 'Outreach Volunteers'],
    ...
    who: 'Mateo Gavilanes (Environment Creator & Lead VR Developer), interdisciplinary engineering team, and outreach volunteers.',
