...
export const NEWS_DATA: NewsArticle[] = [
  ...
  },
  {
    ...
    slug: 'nano-bridge-science-vision-dia-del-nino-hospital-san-vicente',
    title: "Nano Bridge: Science Vision — Children's Day Edition at San Vicente de Paúl Hospital",
    date: 'June 01, 2026',
    category: 'Outreach',
    summary: 'Humanitarian volunteer outreach bringing Virtual Reality simulations to 25 pediatric patients in Ibarra under the Nano Bridge: Science Vision program.',
    content: 'Under the "Nano Bridge: Science Vision" (Children’s Day Edition) initiative, IEEE NTC volunteers conducted a humanitarian outreach at San Vicente de Paúl Hospital in Ibarra. Under clinical biosafety protocols, 25 hospitalized children experienced interactive Virtual Reality simulations with Meta Quest 3 headsets, bringing joy, relaxation, and scientific inspiration.',
    image: '/assets/events/dia_del_nino_hospital.jpg',
    imageAlt: "Nano Bridge: Science Vision Outreach at San Vicente de Paúl Hospital",
