...
export const EVENTS_DATA: EventItem[] = [
  ...
  },
  {
    id: 'logic-lock',
    slug: 'logic-lock',
    title: 'Logic Lock: AI Tool para Referencias Bibliográficas',
    category: 'Past',
    status: 'completed',
    registrationStatus: 'closed',
    type: 'Workshop',
    date: 'March 12, 2026',
    time: '07:30 PM',
    location: 'Yachay Tech University & Online Session',
    modality: 'Hybrid',
    summary: 'Primera reunión técnica del capítulo y presentación de herramienta de IA para sistematización de referencias bibliográficas PRISMA.',
    description: 'Sesión inaugural técnica de IEEE NTC Yachay Tech donde se presentó Logic Lock, una herramienta basada en IA diseñada para la automatización, filtrado y reproducibilidad de revisiones sistemáticas de literatura científica.',
    image: '/assets/events/logic_lock_post.png',
    imageAlt: 'Logic Lock AI Tool para Referencias Bibliograficas 12 de Marzo',
    imageVerified: true,
    featured: false
  },
  {
